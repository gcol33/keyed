---
title: "Getting Started with keyed"
author: "Gilles Colling"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with keyed}
...
- See [Row Identity](row-identity.html) for detailed ID tracking
- See [Drift Detection](drift-detection.html) for snapshot workflows
