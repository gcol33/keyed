...
to the **keyed** project!

This document provides guidelines for contributing to keyed—its codebase and documentation.
...
keyed uses **testthat** for testing.
...
By contributing to keyed, you agree that your code is released under the same license as the package.
